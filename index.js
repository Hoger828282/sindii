...
message.member.voiceChannel.join(850098037358460981) 
...
client.user.setGame(`XaTer up  💙`) 
});




client.login("ODYzNTg1MjcxODY4ODE3NDE4.YOpCdQ.TcIyAAL25YjIwusQ5LUlAEFUdGQ");// Your Token
